...
let timerId = setInterval(function() {
    ...
    seconds--;
    // console.log(seconds);
    if (seconds == 3) alert("\u0417\u0430\u043B\u0438\u0448\u0438\u043B\u043E\u0441\u044C \u043C\u0435\u043D\u044C\u0448\u0435 \u043F\u043E\u043B\u043E\u0432\u0438\u043D\u0438 \u0447\u0430\u0441\u0443!");
    else if (seconds == -1) clearInterval(timerId);
}, 1000);
let timerIdSecond = null;
function resetAnalogClock() {
    if (timerIdSecond) clearInterval(timerIdSecond);
    secondSeconds = 30;
    timer();
}
...
},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequirec242", {})

//# sourceMappingURL=hw-lesson11.31b563d9.js.map
